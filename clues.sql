...
-- Write SQL query here
SELECT * FROM country c LEFT JOIN city d ON c.code = d.countrycode  WHERE c.continent = 'South America' AND d.name  LIKE 'Ser%';
...
-- Write SQL query here
SELECT capital FROM country c LEFT JOIN city d ON c.code = d.countrycode WHERE c.code = 'BRA';
